...
- [x] P17S03f3 — fix `crushr info --entry` argument-order regression/hang by enforcing deterministic archive-path validation, preserving both supported argument forms, and adding bounded regression tests.
