...
Current Step: 2.1 complete (CRUSHR-P2.1-A + CRUSHR-P2.1-B manifest + deterministic fixture/archive foundation)

Recent completed packet: CRUSHR-P2.1-B (deterministic dataset fixture builder, inventory/provenance outputs, typed archive build foundation)

## Current truth

- Phase 1 is complete.
- Phase 2.1 packets CRUSHR-P2.1-A and CRUSHR-P2.1-B are complete: `crushr-lab` now has typed Phase 2 manifest/scenario structures, deterministic locked-core scenario enumeration (2160 runs), deterministic dataset fixture builders (`smallfiles`, `mixed`, `largefiles`), deterministic inventory/provenance emission, and typed archive build execution records for `crushr`, `tar+zstd`, `zip`, and `7z/lzma`.
