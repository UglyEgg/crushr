...
These documents define the non-negotiable boundaries for crushr.
...
- `EXTRACTION_RESULT_V1.md` — deterministic `crushr-extract --json` result contract for minimal v1
- `PROPAGATION_GRAPH_V1.md` — deterministic minimal-v1 corruption propagation graph contract
