...
- FORMAT-15 extends dictionary naming with generation-aware mirrored copies and factored namespace dictionaries (`dir_id`/`name_id`/`file_bindings`) while retaining fail-closed naming semantics.
